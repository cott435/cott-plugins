...
concrete. It is the design doc `/dev-team:finalize-package` builds from, and the plan-time twin of
...
*inferred*, and note that the package is not shipped until `/dev-team:finalize-package` runs.
