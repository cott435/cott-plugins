...
`docs/plans/<slug>/integration.md`; `/dev-team:map-project` and adoption runs write it about existing
...
8. **Canonical doc updates** *(change plans only)* — which canonical docs `/dev-team:sync-plan` must
