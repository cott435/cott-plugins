...
5. Write the inventory and **stop** with exactly:
   ...
   Mark `keep` on every row, merge rows that belong in one skill, name the skills, then re-run `/dev-team:extract-legacy`.
   ```
